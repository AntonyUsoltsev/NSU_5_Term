...
public class UdpController implements Runnable {
    ...
    public synchronized void setNewGame(int width, int height, int foodCount, int TimeDelay, int role) {
        SnakesProto.GameAnnouncement gameAnnouncement = createAnnouncement(width, height, foodCount, TimeDelay, role);
    ...
    public SnakesProto.GameAnnouncement createAnnouncement(int width, int height, int foodCount, int TimeDelay, int role) {
